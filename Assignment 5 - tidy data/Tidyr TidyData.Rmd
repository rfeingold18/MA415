...
setwd("~/MA415/Assignment 5 - tidy data")
```
Table 1 
based on values produced by a function called preg.r
  
you'll note that the values for Table 1 are in a variable called preg.  And you should notice that preg is not a data.frame
```{r}
